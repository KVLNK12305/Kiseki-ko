...
const Main_story = () => {
    ...
    useGSAP(() => {
        ...
        // Image — fade up with slight delay
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-16 relative z-10">
                ...
                {/* LEFT: Text Content */}
                <div ref={textRef} className="flex-1 text-left max-w-2xl" style={{ opacity: 0 }}>
                ...
                {/* RIGHT: Image Content */}
                <div ref={imageRef} className="flex-1 w-full max-w-md lg:max-w-lg flex justify-center lg:justify-end relative" style={{ opacity: 0 }}>
