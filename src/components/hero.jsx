...
const Hero = () => {
    ...
    return (
        <section
            ...
            className="relative min-h-[100dvh] lg:h-[100dvh] w-full bg-[#030305] overflow-hidden flex flex-col justify-between select-none py-2 lg:py-0"
        >
            ...
            <div ref={slashRef} className="relative w-full h-full flex flex-col justify-between flex-1">
                ...
                <header className="hero-header-bar relative z-30 w-full px-5 sm:px-10 lg:px-16 pt-5 lg:pt-8 flex items-center justify-between text-xs font-mono tracking-widest text-[#9090A8] uppercase border-b border-white/5 pb-3.5">
                    ...
                    <div className="flex items-center gap-4 sm:gap-8">
                        ...
                        <div className="flex items-center gap-1.5 text-[#FFD700]">
                            ...
                            <span className="font-mono font-medium text-[11px] sm:text-xs">{currentTime || '08:00:00 PM'}</span>
                        </div>
                    </div>
                </header>
                ...
                <div className="relative z-20 flex-1 w-full max-w-[1700px] mx-auto px-5 sm:px-10 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 py-4 lg:py-2">
                    ...
                    <motion.div
                        ...
                        className="hero-left-pane z-20 flex-1 max-w-lg text-left w-full"
                    >
                        {/* Operator Badge */}
                        ...
                        <div className="text-lg sm:text-2xl lg:text-[1.75rem] font-mono text-[#FFD700] font-bold mb-3 sm:mb-4 tracking-wide leading-tight space-y-0.5">
                            <div>I BUILD.</div>
                            <div>I BREAK.</div>
                            <div>I REBUILD.</div>
                        </div>
                        ...
                        {/* Engineered Copy */}
                        <div className="space-y-1.5 mb-6 sm:mb-8 text-[#C8C8D4] text-xs sm:text-sm lg:text-base leading-relaxed max-w-md">
                            <p>
                            ...
                            <p className="text-[#9090A8] text-[11px] sm:text-xs font-mono">
                                Turning complexity into bare-metal performance.
                            </p>
                        </div>

                        {/* Mobile Personality Capsule */}
                        <div className="lg:hidden flex items-center gap-3 mb-6 font-mono text-[11px] text-[#A855F7] tracking-widest uppercase">
                            <span style={{ fontFamily: 'Caveat, cursive' }} className="text-xl text-[#FFD700] lowercase font-bold">art.</span>
                            <span>·</span>
                            <span style={{ fontFamily: 'Caveat, cursive' }} className="text-xl text-[#F0EDE8] lowercase font-bold">cook.</span>
                            <span>·</span>
                            <span style={{ fontFamily: 'Caveat, cursive' }} className="text-xl text-[#A855F7] lowercase font-bold">life.</span>
                        </div>
                    ...
                    <motion.div
                        ...
                        className="hero-right-pane hidden lg:flex z-20 flex-1 max-w-[240px] text-left flex-col justify-center"
                    >
                        {/* Reframed Header */}
